...
package com.qaziconsulltancy.quranlibrary.bookmarks;
...
public class BookmarksEdit extends Activity {
    ...
    private void populateFields() {
        if (mRowId != null) {
            ...
            mTitleText.setText(note.getString(
                    note.getColumnIndexOrThrow(BookmarksDbAdapter.KEY_TITLE)));
            mBodyText.setText(note.getString(
                    note.getColumnIndexOrThrow(BookmarksDbAdapter.KEY_BODY)));
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        saveState();
        outState.putSerializable(BookmarksDbAdapter.KEY_ROWID, mRowId);
    }
