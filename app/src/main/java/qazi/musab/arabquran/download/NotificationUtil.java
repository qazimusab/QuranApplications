...
import qazi.musab.arabquran.util.StorageUtil;
import qazi.musab.arabquran.util.Utils;

public class NotificationUtil {

	public static final int NOTIFY_ID_PROGRESS = 1;
	private static NotificationManager nm;
	private static final String URL = "http://www.qaziconsultancy.com/Quran/zip_folder/ArabQuranBlue.zip";
	...
	private static void setNotificationIcon(Context context,
		...
		mBuilder.setLargeIcon(BitmapFactory.decodeResource(
				context.getResources(), R.drawable.iconcotification));
		mBuilder.setSmallIcon(R.drawable.iconcotification);
	}
