...
public class DownloadActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    alertbox5.setIcon(android.R.drawable.stat_notify_error);
              ...
              alertbox5.setMessage("To start reciting the Quran, you will need to download some files from the internet. Please make sure you have 140mb of free space before you start. Would you like to start the download now?");
