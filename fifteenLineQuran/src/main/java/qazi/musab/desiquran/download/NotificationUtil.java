...
import qazi.musab.desiquran.util.StorageUtil;
import qazi.musab.desiquran.util.Utils;

public class NotificationUtil {

	public static final int NOTIFY_ID_PROGRESS = 1;
	private static NotificationManager nm;
    private static final String URL = "http://www.qaziconsultancy.com/Quran/zip_folder/15LineQuran.zip";
