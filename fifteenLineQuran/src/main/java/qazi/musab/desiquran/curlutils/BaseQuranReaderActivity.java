...
import qazi.musab.desiquran.bookmarks.BookmarksDbAdapter;
import qazi.musab.desiquran.download.NotificationDownloader;
import qazi.musab.desiquran.subscription.YearlySubscriptionActivity;
import qazi.musab.desiquran.util.Contributor;
import qazi.musab.desiquran.util.Dialogs;
import qazi.musab.desiquran.util.Encryter;

/**
 * Created by Musab on 8/20/2014.
 */
@SuppressWarnings("ALL")
public abstract class BaseQuranReaderActivity extends BaseActivity {
    protected IInAppBillingService mservice;
    protected ServiceConnection connection;
    protected Contributor contributor;
    protected SharedPreferences sharedPref;
    protected SharedPreferences.Editor editor;
    protected ChildCurlView mCurlView;
    ...
    protected void checkIfTrialFinished() {
        File file = new File(Environment.getExternalStorageDirectory().getPath() +"/Pictures/.15LineQuran/15 Line Quran/config.txt");
        String line = null;
        Date startDate = null;
    ...
    protected void initCurlView() {
        mCurlView = (ChildCurlView) findViewById(R.id.curl);
    ...
    protected void checkIfImagesExist() {
        File n=new File(Environment.getExternalStorageDirectory().getPath()+"/Pictures/.15LineQuran/15 Line Quran/616.jpg");
        File file = new File(Environment.getExternalStorageDirectory().getPath() +"/Pictures/15LineQuran.zip");
    ...
    protected int getResId(ChildCurlView mCurlView,ImageView imageView, String name) {
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState)
    {
        ...
        if(isZoomed&&getScreenOrientation()==Configuration.ORIENTATION_PORTRAIT)
        {
            try{
                ...
                File file = new File(Environment.getExternalStorageDirectory().getPath()+"/Pictures/.15LineQuran/15 Line Quran/"+(616-mCurlView.getCurrentIndex())+".jpg");
