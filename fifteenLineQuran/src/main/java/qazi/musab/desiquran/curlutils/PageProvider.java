 ...
 */
public class PageProvider implements ChildCurlView.PageProvider {
    ...
    private Bitmap loadBitmap(int width, int height, int index) throws IOException, ExecutionException, InterruptedException {
        ...
        Drawable d;
        //if(index==610){
        String pathName = Environment.getExternalStorageDirectory().getPath()+"/Pictures/.15LineQuran/15 Line Quran/"+(616-index)+".jpg";
