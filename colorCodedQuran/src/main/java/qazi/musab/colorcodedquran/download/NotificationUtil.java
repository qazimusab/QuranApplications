...
import qazi.musab.colorcodedquran.util.StorageUtil;
import qazi.musab.colorcodedquran.util.Utils;
...
public class NotificationUtil {
    ...
    private static final String URL = "http://www.qaziconsultancy.com/Quran/zip_folder/TajweedQuran.zip";
    ...
    public static String fileName ="TajweedQuran.zip";
