package qazi.musab.colorcodedquran.download;
...
import qazi.musab.colorcodedquran.util.StringUtil;
...
public class ProgressAsyncTask extends AsyncTask<Object, Integer, Object> {
    ...
    private class ExtractTask extends AsyncTask<Void, Double, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            String zipFilePath=fileSavePath+"/"+fileName;
            String extractPath=fileSavePath+"/"+"."+fileName.substring(0,fileName.indexOf('.'))+"/";
            try {
                u.unzip(zipFilePath, extractPath);
	 ...
	 *
	 * @see qazi.musab.colorcodedquran.download.ProgressAsyncTask#notifyLowVersionNotification
	 * @see qazi.musab.colorcodedquran.download.ProgressAsyncTask#notifyHighVersionNotification
	 */
